...
ready(function() {
  ...
  // Mostrar/ocultar la sección correspondiente según el método de pago seleccionado
  document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('input[name="metodo_pago"]').forEach(function(radio) {
      radio.addEventListener('change', function() {
        document.getElementById('yape-qr-section').classList.add('hidden');
        document.getElementById('bcp-section').classList.add('hidden');
        document.getElementById('visa-section').classList.add('hidden');
        if (this.value === 'yape') {
          document.getElementById('yape-qr-section').classList.remove('hidden');
        }
        if (this.value === 'bcp') {
          document.getElementById('bcp-section').classList.remove('hidden');
        }
        if (this.value === 'visa') {
          document.getElementById('visa-section').classList.remove('hidden');
        }
      });
    });
  });
